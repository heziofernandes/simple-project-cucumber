...
import simpleproject.pages.RegisterPage;
...
public class RegisterSteps {
	private RegisterPage registerFields;
	private WebDriver driver;

	public RegisterSteps() {
		driver = new BasePage().getDriver();
		registerFields = PageFactory.initElements(driver, RegisterPage.class);
	}
